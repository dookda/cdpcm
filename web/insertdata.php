...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { 
    ...
    $sql = "INSERT INTO data_tab (disea_gr,disea_sgrp,title,author,std_area,objective,cost_design,abstract,year_pub,orig_link,std_year,std_design,samp_area,samp_size,samp_meth,missing,pub_type,activity0,activity1,type_cost0,type_cost1,perspect,time_unit,perso_unit,cost_thb,remark,srvofftype,sr_group,gr_name,itemid,item,itemcode,unit,rvu,genhos,commhos) 
        VALUES ('$disea_gr','$disea_sgrp','$title','$author','$std_area','$objective','$cost_design','$abstracts',$year_pub,'$orig_link','$std_year','$std_design','$samp_area','$samp_size','$samp_meth','$missing','$pub_type','$activity0','$activity1','$type_cost0','$type_cost1','$perspect','$time_unit','$perso_unit',$cost_thb,'$remark','$srvofftype','$sr_group','$gr_name','$itemid','$item','$itemcode','$unit',$rvu,$genhos,$commhos)"; 
    $result = pg_query($sql);    
